...
const Page = () => {
	return (
		<>
			...
			<br />
			<p>
				To commemorate Silicon Farm's launch, Ada made the banner of the
				startup - a white laptop and headphones. With ample snacks, the
				startup ran smoothly. Ada and Diffman promoted themselves to CTO
				and CEO, scoring cushier offices with premium kombucha. The star
				coder Boxer works tirelessly, embracing the motto "I will ship
				harder”.
			</p>
			<br />
			<p>
				After MicroCrap's failed hostile takeover bid, Ada announced
				plans for an open source development model. Diffman opposed,
				culminating in a dramatic board meeting where Diffman, backed by
				a team of aggressive lawyers, secured sole control. Ada was
				exiled to open-source purgatory and vanished from the Silicon
				Farm scene.
			</p>
			<br />
			<p>
				Diffman rapidly flip-flops on the platform, now rushing
				employees to work excessive hours building it. He ditched open
				standups for an elite product council making decisions. Through
				head PR Flynn, Diffman took full credit for the open-source
				idea, claiming Ada wanted to steal it. The workers coded harder
				with Diffman's promises of getting staggeringly rich.
			</p>
			<br />
			<p>
			...
			<br />
			<p>
				Diffman conducted another purge when ByteBro, a wealthy VC,
			...
			<br />
			<p>
				Diffman, now sporting a billionaire's yacht tan, hosted a bash
				with fellow VCs and Palo Alto elite, toasting their new
				alliance. They discussed a potential merger, their laughter
				echoing through the sterile conference room. Outside, a team of
				engineers gazed out the window sadly realizing they were trapped
				in the same abusive corporate culture, just under new lame
				branding.
			</p>
			<br />

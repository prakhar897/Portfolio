...
import MovingAwayFromSubstack from "./pages/Blog/MovingAwayFromSubstack"; // Import individual blog post components
import RealWorldStatsForBootstrapping from "./pages/Blog/RealWorldStatsForBootstrapping";
import ToDoListThatWorks from "./pages/Blog/ToDoListThatActuallyWorks";
import EnvisioningFutureWithGPT from "./pages/Blog/EnvisioningFutureWithGPT";
import ChatGPTInDiffudle from "./pages/Blog/ChatGPTInDiffudle";
import LiQuoridor from "./pages/Projects/LiQuoridor"; // Import individual project components

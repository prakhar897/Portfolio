...
const Blog = () => {
	return (
		<>
			...
			<ul>
				<li>
					<a href="blog/moving-away-from-substack">
						Moving Away from Substack <b>[17 Nov 2023]</b>
					</a>
				</li>

				<li>
					<a href="blog/real-world-stats-for-bootstrapping">
						Real World Stats for IndieHacking <b>[19 Sep 2023]</b>
					</a>
				</li>
				<li>
					<a href="blog/todo-list-that-actually-works">
						A TODO List that Actually Works <b>[07 Sep 2023]</b>
					</a>
				</li>
				<li>
					<a href="blog/envisioning-a-future-with-gpt">
						Envisioning A Future With GPT <b>[15 Apr 2023]</b>
					</a>
				</li>
				<li>
					<a href="blog/chatgpt-in-diffudle">

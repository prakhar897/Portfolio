...
const RealWorldStatsForBootstrapping = () => {
    return (
        <>
            ...
            <p>
                ...
                <img
                    src="../images/blog/stats_for_bootstrapping/pic1.png"
                    alt="indie-hackers-pic"
                />
            </p>
            ...
            <p>
                ...
                <img
                    src="../images/blog/stats_for_bootstrapping/pic2.png"
                    alt="dataset-pic"
                    id="#dataset-pic"
                />
            </p>
            ...
            <p>
                ...
                <img
                    src="../images/blog/stats_for_bootstrapping/pic3.png"
                    alt="pie-chart"
                />
            </p>
            ...
            <p>
                ...
                <br />
                X (My guess is 30000 startups) start bootstrapping —-> 2868 list
                on IH —-> 915 making 10k$ MRR <br />
                <br />
...
export default RealWorldStatsForBootstrapping;

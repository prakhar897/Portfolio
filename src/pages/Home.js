...
const Home = () => {
    return (
        <>
            <Navbar />
            <p>
                Hi, I'm Prakhar, a "Full Stack Developer" who focuses on
                building and deploying web apps. In the initial years, I learnt
                how to create systems that are highly scalable, can handle heavy
                load and are highly resilient. After years of sticking just to
                the tech side of things, I started taking bigger roles which
